...
---
flowchart TB
    classDef harness fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef model fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef you fill:#2d2d2d,stroke:#e5c07b,color:#fff
    ...
    style YOU fill:#1a1a2e,stroke:#e5c07b,color:#fff
    style HARNESS fill:#1a1a2e,stroke:#98c379,color:#fff
    style MODEL fill:#1a1a2e,stroke:#61dafb,color:#fff
```
...
---
flowchart TB
    classDef l1 fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef l2 fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef l3 fill:#2d2d2d,stroke:#98c379,color:#fff
...
---
flowchart LR
    classDef step fill:#2d2d2d,stroke:#98c379,color:#fff
...
---
flowchart TB
    classDef fail fill:#2d2d2d,stroke:#e06c75,color:#fff
    classDef fix fill:#2d2d2d,stroke:#98c379,color:#fff
...
flowchart LR
    ...
    style Vibe fill:#1a1a2e,stroke:#e5c07b,color:#fff
    style Agentic fill:#1a1a2e,stroke:#98c379,color:#fff
```
...
---
flowchart LR
    classDef phase fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef compact fill:#2d2d2d,stroke:#e5c07b,color:#fff
...
> 📖 多 Agent 协作的完整架构和深度实战见 → [Ch11 · 多 Agent 协作](../ch11-multi-agent/part-11-multi-agent.md)
...
---
flowchart LR
    classDef l1 fill:#2d2d2d,stroke:#e06c75,color:#fff
    classDef l2 fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef l3 fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef l4 fill:#2d2d2d,stroke:#c678dd,color:#fff
    classDef l5 fill:#2d2d2d,stroke:#98c379,color:#fff
...
> 📖 深度参考：
> - [附录：人机协同与 Agent 优化指南](../ch02-concepts/reference-human-agent-collaboration.md)（Harness 六层架构、Token 节约详解、大型项目策略、Agent Team 互审）
