...
flowchart LR
    ...
    G["Glob 先扫描目录结构"]:::tool
    R["Read 读取关键文件"]:::tool
    S["Grep 追踪关键符号与调用链"]:::tool
    A["分析归纳 汇总形成结论"]:::output
...
[📚 返回目录](../../README.md#tutorial-contents) | [📋 规划优先与 Prompt 工程](./topic-plan-prompt-engineering.md)
