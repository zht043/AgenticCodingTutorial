...
flowchart TB
    ...
    classDef think fill:#c678dd,stroke:#2d2d2d,stroke-width:2px,color:#fff
    ...
    classDef decide fill:#e06c75,stroke:#2d2d2d,stroke-width:2px,color:#fff
...
flowchart TB
    ...
    classDef ext fill:#c678dd,stroke:#2d2d2d,stroke-width:2px,color:#fff
    classDef orch fill:#e06c75,stroke:#2d2d2d,stroke-width:2px,color:#fff
...
flowchart LR
    ...
    classDef lost fill:#e06c75,stroke:#2d2d2d,stroke-width:2px,color:#fff
...
flowchart LR
    ...
    classDef bad fill:#e06c75,stroke:#2d2d2d,stroke-width:2px,color:#fff
...
graph TD
    ...
    style A fill:#e06c75,stroke:#2d2d2d,color:#fff
    style G fill:#e06c75,stroke:#2d2d2d,color:#fff
```
...
[📚 返回目录](../../README.md) | [⬅️ 上一章：Ch04 第一批实战](../ch04-first-practice/index.md) | [➡️ 下一章：Ch06 代码探索与验证](../ch06-explore-verify/index.md)
