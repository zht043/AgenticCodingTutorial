...
flowchart LR
    ...
    style Confirm fill:#2d2d2d,stroke:#e5c07b,color:#fff
    style A fill:#2d2d2d,stroke:#98c379,color:#fff
    style V fill:#2d2d2d,stroke:#c678dd,color:#fff
```
...
flowchart TB
    ...
    style L1 fill:#2d2d2d,stroke:#61dafb,color:#fff
    style L2 fill:#2d2d2d,stroke:#e5c07b,color:#fff
    style L3 fill:#2d2d2d,stroke:#98c379,color:#fff
```
...
[📚 返回目录](../../README.md) | [⬅️ 上一章：Ch03 术语速查手册](../ch03-glossary/index.md) | [➡️ 下一章：Ch05 Agent 内部机制](../ch05-agent-mechanics/index.md)
