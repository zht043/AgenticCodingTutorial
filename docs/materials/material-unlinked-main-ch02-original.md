...
> ⚠️ 这是 main 分支原始 Chapter 2 的完整留档，用于重构期对照与回收原文，不在当前公开主线中直接导航。
...
> 📖 **阅读方式建议**：如果你对 `LLM / Context / Token / MCP / Skill / Harness` 这些词还不熟，可以把 [术语速查手册](../chapters/ch03-glossary.md) 另开一页，边读边查；本章主线已经尽量自洽，不要求你先把术语全背下来。
>
...
- 📘 遇到术语卡壳时，随时打开：[术语速查手册](../chapters/ch03-glossary.md)
...
- 🔌 想理解扩展机制的深水区：[MCP 协议](../topics/topic-mcp.md) / [Skill 系统](../topics/topic-skills.md) / [Ch07 · 扩展生态与会话管理](../chapters/ch03-first-extension-setup.md)
...
[📚 返回目录](../../README.md#tutorial-contents) | [⬅️ 上一章：Ch01 快速上手](../chapters/ch01-quickstart.md) | [➡️ 下一章：Ch04 第一批实战](../chapters/ch02-agent-first-practice.md)
