...
---
flowchart LR
    classDef fast fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef slow fill:#2d2d2d,stroke:#e06c75,color:#fff
    classDef neutral fill:#2d2d2d,stroke:#61dafb,color:#fff
...
---
flowchart TB
    classDef writer fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef reviewer fill:#2d2d2d,stroke:#e06c75,color:#fff
    classDef human fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef action fill:#2d2d2d,stroke:#61dafb,color:#fff
    ...
    style PHASE1 fill:#1a1a2e,stroke:#98c379,color:#fff
    style PHASE2 fill:#1a1a2e,stroke:#e06c75,color:#fff
    style PHASE3 fill:#1a1a2e,stroke:#e5c07b,color:#fff
```
...
---
flowchart TB
    classDef auto fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef agent fill:#2d2d2d,stroke:#c678dd,color:#fff
    classDef human fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef pass fill:#2d2d2d,stroke:#98c379,color:#fff
    ...
    style L1 fill:#1a1a2e,stroke:#61dafb,color:#fff
    style L2 fill:#1a1a2e,stroke:#c678dd,color:#fff
    style L3 fill:#1a1a2e,stroke:#e5c07b,color:#fff
```
...
[📚 返回目录](../../README.md) | [⬅️ 上一章：Ch11 Agent 设计模式](../ch11-design-patterns/index.md) | [➡️ 下一章：Ch13 技术发展简史](../ch13-history/index.md)
