...
```mermaid
flowchart LR
    classDef default_mode fill:#2d2d2d,stroke:#e5c07b
    classDef edit_mode fill:#2d2d2d,stroke:#61dafb
    classDef bypass_mode fill:#2d2d2d,stroke:#e06c75
...
```mermaid
flowchart TB
    classDef mcp fill:#2d2d2d,stroke:#61dafb
    classDef skill fill:#2d2d2d,stroke:#98c379
    classDef plugin fill:#2d2d2d,stroke:#c678dd
...
```mermaid
flowchart LR
    classDef red fill:#2d2d2d,stroke:#e06c75
    classDef green fill:#2d2d2d,stroke:#98c379
    classDef refactor fill:#2d2d2d,stroke:#61dafb
...
```mermaid
flowchart LR
    classDef early fill:#2d2d2d,stroke:#98c379
    classDef late fill:#2d2d2d,stroke:#e06c75
...
[📚 返回目录](../../README.md#tutorial-contents) | [⬅️ 上一章：Ch07 规划与 Prompt 工程](../ch07-plan-prompt/part-7-plan-prompt.md) | [➡️ 下一章：Ch09 工程化工作流](../ch09-engineering/part-9-engineering.md)
