...
以下评分并非 benchmark 数据，而是基于近 12 个月公开社区反馈（GitHub issue、Reddit、HN、知乎、SegmentFault 等）的出现**频次与强度**做相对量化，反映的是"口碑画像"，不能与性能评测直接对比。

> 评分说明：1 = 负反馈较集中；5 = 正反馈较集中。

| 模型 | 代码质量 | 指令遵循 | 长上下文/大库 | 稳定性 | 速度 | 成本效率 | 工具/智能体体验 | 安全/隐私信心 | 平均 |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Claude Opus 4.5 | 4 | 3 | 3 | 3 | 4 | 2 | 4 | 3 | 3.25 |
| Claude Opus 4.6 | 4 | 2 | 5 | 2 | 3 | 2 | 5 | 2 | 3.12 |
| GPT-5.3-Codex | 4 | 3 | 4 | 3 | 5 | 4 | 4 | 3 | 3.75 |
| GPT-5.4 | 4 | 3 | 5 | 2 | 4 | 3 | 5 | 4 | 3.75 |

几个值得注意的对比点：Opus 4.6 在长上下文和工具/智能体体验两个维度评分最高，但稳定性和指令遵循拖了均分——社区反馈的核心是"能力上限很高，但对 prompt 质量和护栏设计的要求也更高"。GPT-5.3-Codex 在速度和成本效率两维最突出，稳定性问题则集中在安全路由降级而非模型本体。GPT-5.4 整体均分与 Codex 相近，但稳定性同样偏低，主要来自 2026-03-10 前后的可用性事件。
