...
> 📖 想了解 CLI、VS Code 插件、桌面应用之间的关系？见 → [附录：CLI / IDE 插件 / 桌面应用形态详解](./reference-cli-ide-app.md)
...
[📚 返回目录](../../README.md#tutorial-contents) | [➡️ 下一章：Ch02 Agent 核心原理](../ch02-concepts/part-2-concepts.md)
