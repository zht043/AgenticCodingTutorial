...
---
flowchart LR
    classDef explore fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef plan fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef code fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef check fill:#2d2d2d,stroke:#c678dd,color:#fff
...
flowchart TB
    ...
    classDef plan fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef code fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef feedback fill:#2d2d2d,stroke:#c678dd,color:#fff
...
[📚 返回目录](../../README.md) | [⬅️ 上一章：Ch06 代码探索与验证](../ch06-explore-verify/index.md) | [➡️ 下一章：Ch08 扩展生态与会话管理](../ch08-config-session/index.md)
