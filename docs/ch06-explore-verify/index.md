...
---
flowchart LR
    classDef tool fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef output fill:#2d2d2d,stroke:#98c379,color:#fff
...
flowchart TB
    ...
    classDef check fill:#2d2d2d,stroke:#e5c07b,color:#fff
    classDef success fill:#2d2d2d,stroke:#98c379,color:#fff
...
---
flowchart TB
    classDef phase fill:#2d2d2d,stroke:#61dafb,color:#fff
    classDef action fill:#2d2d2d,stroke:#98c379,color:#fff
    classDef verify fill:#2d2d2d,stroke:#e5c07b,color:#fff
    ...
    style PHASE1 fill:#1a1a2e,stroke:#61dafb,color:#fff
    style PHASE2 fill:#1a1a2e,stroke:#e5c07b,color:#fff
    style PHASE3 fill:#1a1a2e,stroke:#98c379,color:#fff
```
...
[📚 返回目录](../../README.md) | [⬅️ 上一章：Ch05 Agent 内部机制](../ch05-agent-mechanics/index.md) | [➡️ 下一章：Ch07 规划与 Prompt 工程](../ch07-plan-prompt/index.md)
