...
> 📌 **本章只回答一个问题**：怎样让 Agent 不抢跑？如果 Ch06 解决的是“让 Agent 看懂项目并会自证”，本章解决的就是“怎样让它按你的节奏推进，而不是一上来把仓库改穿”。
...
[📚 返回目录](../../README.md#tutorial-contents) | [⬅️ 上一章：Ch06 代码探索与验证](./ch06-explore-verify.md) | [➡️ 下一章：Ch08 扩展生态与会话管理](./ch08-config-session.md)
