...
模型、工具、benchmark 的横向分析原来都在专题里。这里先原样并入，保证 Part IV 后面能直接作为深度资料阅读。

<details>
<summary>📎 保留原文：原专题：主流 Coding 模型横评</summary>
...
> 下一步建议：如果你想知道这些 benchmark 到底各自测什么、为什么同一模型在不同榜单会像"两个人"，接着看 [模型与 Agent 评测体系](../topics/topic-benchmarks.md)。
...
<details>
<summary>📎 保留原文：原专题：主流 Agent 工具横评</summary>
...
> 继续读：如果你已经确定工具形态，下一步建议看 [`附录：主流 Coding 模型对比`](../topics/topic-model-comparison.md)。

---

返回：[附录：Agent 工具与模型详细对比](../topics/topic-agent-tools-comparison.md)
返回目录：[README · 章节目录](../../README.md#tutorial-contents)
...
> 继续读：如果你想把这些心得变成一套更稳的工作流，接着看 [`附录：上下文工程、验证闭环与常见失败模式`](../topics/topic-context-engineering.md)。
...
<details>
<summary>📎 保留原文：原专题：模型与 Agent 评测体系</summary>
