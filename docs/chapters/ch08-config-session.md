...
> 🎯 **章节分工提醒**：这一节负责具体命令和操作时机；Ch10 只讨论为什么这些动作属于控制面，以及你该如何把它们纳入长期协作策略。
...
恭喜你完成了基础实战篇的全部内容！理论基础已经在 `Ch02` 打好，从 `Ch04` 到 `Ch08` 你进一步把这些认知变成了真实工作流：
...
flowchart LR
    ...
    C6["Ch06<br/>建立验证驱动工作流"]:::done
    C7["Ch07<br/>学会规划优先与约束"]:::done
    C8["Ch08<br/>掌握配置、扩展与会话管理"]:::done
