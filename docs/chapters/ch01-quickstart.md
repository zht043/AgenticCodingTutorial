...
这章沿用了原快速开始主线，但为了满足“先重排后裁剪”的原则，这里把 main 分支的原完整版本也原样保留下来，方便后续继续取舍。

<details>
<summary>📎 保留原文：main 分支原 Chapter 1：快速开始</summary>
...
>
> 📖 想了解详细的选型分析，见 Reference 文档：
> - [附录：主流 Agent 工具对比](./ch23-models-tools-benchmarks.md)
> - [附录：主流 Coding 模型对比](./ch23-models-tools-benchmarks.md)
> - [附录：模型与 Agent 评测体系详解](./ch23-models-tools-benchmarks.md)
...
👉 下一章：[Chapter 2 · 🧩 Agent 核心概念](./ch08-agent-formula.md)

---

<div align="center">

[📚 返回目录](../../README.md#tutorial-contents) | [➡️ 下一章：Ch02 Agent 核心原理](./ch08-agent-formula.md)
