...
质量保障与验收章节先保留旧质量章节原文，再和当前更清晰的 Verify / Review / Eval 框架并存，方便后续裁剪。

<details>
<summary>📎 保留原文：原 Chapter 11：质量保障与验收</summary>
...
> 📌 **章节职责**：Ch10 解释为什么要把“写、审、验收、护栏”拆开；本章只关注怎么把它们排成一条可执行、可复盘、可合并的交付链。
...
如果你已经读过 Ch10，可以把本章理解成：**把 Writer-Reviewer、验收标准、CI 门禁、合并清单串成一条真实可执行的 PR 流水线。**
...
> 📖 **延伸阅读**：如果你想继续深挖幻觉的分类、技术成因和架构级缓解，继续看 [🧠 大模型幻觉问题](./ch17-agent-failure-modes.md)。
...
[📚 返回目录](../../README.md#tutorial-contents) | [⬅️ 上一章：Ch10 Agent 设计模式与代码库策略](./ch18-agent-patterns.md) | [➡️ 下一章：Ch12 技术简史与当前定位](./ch22-history-evolution-timeline.md)
