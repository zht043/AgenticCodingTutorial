...
> 📖 **延伸阅读**：如果你想继续深挖幻觉的分类、技术成因和架构级缓解，继续看 [🧠 大模型幻觉问题](../topics/topic-llm-hallucination.md)。
...
[📚 返回目录](../../README.md#tutorial-contents) | [⬅️ 上一章：Ch10 Agent 设计模式与代码库策略](./ch10-design-patterns.md) | [➡️ 下一章：Ch12 技术简史与当前定位](./ch12-history.md)
