...
Tools 章节先保留两类重要原文：CLI/MCP 的选择框架，以及 MCP/Skill/插件那套完整四层对比。后续再决定哪些拆到独立章，哪些留在总图里。

<details>
<summary>📎 保留原文：原专题：CLI vs MCP 选择</summary>
...
> 📖 **相关章节**：[🔌 MCP 协议专题](../topics/topic-mcp.md) · [📝 Skill 系统专题](../topics/topic-skills.md) · [Ch07 · 扩展生态与会话管理](../chapters/ch03-first-extension-setup.md)
...
<details>
<summary>📎 保留原文：原附录：MCP 与 Skills 详解</summary>

# 附录：MCP 与 Skills 详解

> 本文是 [Chapter 2 · Agent 运作原理与核心概念](../chapters/ch08-agent-formula.md) 的扩展附录，深入讲解 MCP 协议、Skills 体系和工具生态。
...
返回主文档：[Chapter 2 · Agent 运作原理与核心概念](../chapters/ch08-agent-formula.md)
