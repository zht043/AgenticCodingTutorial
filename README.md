...
| 误区 | 现实 |
| --- | --- |
| 「Agent 就是更聪明的 ChatGPT」 | Agent = LLM + 工具 + 记忆 + 规划循环。ChatGPT 默认交互形态更像对话，而 Agent 会自己动手改代码、跑测试、修 bug（ChatGPT 本身也已具备搜索、文件分析、跨会话记忆等能力） |
...
- 🔌 **工具与能力沉淀** — 用 CLI / 脚本 / MCP / Skills 把团队经验沉淀成可复用能力
